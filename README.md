...
20. **Get Department by ID**
    ...
    - Responses: 
        - 200: Success. Returns the department data with the specified ID.
        - 404: Not Found. If the department with the specified ID does not exist, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
21. **Change Department Head**
    ...
    - Responses: 
        - 200: Success. Returns the updated department data in the response body.
        - 400: Bad Request. If the request is invalid, returns an error model.
        - 404: Not Found. If the specified department or new head department does not exist, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
22. **Create Exam**
    ...
    - Responses: 
        - 201: Created. Returns the created exam data in the response body.
        - 400: Bad Request. If the request is invalid, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
23. **Get All Exams**
    - `GET /api/v1/exams`
    - Responses: 
        - 200: Success. Returns an array of exam data in the response body.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
24. **Get Exam by ID**
    ...
    - Responses: 
        - 200: Success. Returns the exam data with the specified ID.
        - 404: Not Found. If the exam with the specified ID does not exist, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
25. **Update Exam**
    ...
    - Request Body:
        - JSON object following the schema defined in `ExamDTO`.
    - Responses: 
        - 200: Success. Returns the updated exam data in the response body.
        - 400: Bad Request. If the request is invalid, returns an error model.
        - 404: Not Found. If the specified exam does not exist, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
26. **Delete Exam**
    ...
    - Responses: 
        - 200: Success. Returns the deleted exam data in the response body.
        - 404: Not Found. If the specified exam does not exist, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
27. **Get Upcoming Exams**
    ...
    - Parameters:
        - `days` (query parameter): Number of days for upcoming exams (integer).
    - Responses: 
        - 200: Success. Returns an array of upcoming exam data in the response body.
        - 404: Not Found. If no upcoming exams are found, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.
...
28. **Get Exams by Date**
    ...
    - Responses: 
        - 200: Success. Returns an array of exam data for the specified date in the response body.
        - 400: Bad Request. If the request is invalid, returns an error model.
        - 404: Not Found. If no exams are found for the specified date, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.

29. **Get Offline Exams**
    - `GET /api/v1/exams/offline`
    - Responses: 
        - 200: Success. Returns an array of offline exam data in the response body.
        - 404: Not Found. If no offline exams are found, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.

30. **Get Online Exams**
    - `GET /api/v1/exams/online`
    - Responses: 
        - 200: Success. Returns an array of online exam data in the response body.
        - 404: Not Found. If no online exams are found, returns an error model.
        - 500: Server Error. If an unexpected error occurs, returns an error model.

### Faculty Endpoints
Certainly! Below are the endpoints provided in the OpenAPI specification:
